...
namespace NovaCommerce.Identity.Domain
{
    public class Trace
    {
        ...
        [Required]
        public string Operation { get; set; } // Action performed (e.g., "UserRegistered", "UserLoggedIn")

        [Required]
        public string Entity { get; set; } // Affected entity type (e.g., "Customer", "Session")
